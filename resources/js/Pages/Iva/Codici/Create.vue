...
function submit() {
    form.post(route('iva.codici.store'), {
        onSuccess: () => {
...
<template>
    <Head title="Nuovo Codice IVA" />

    <AppLayout>
        <div class="max-w-2xl mx-auto px-4 py-8">
            <!-- Header -->
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-3xl font-bold text-gray-900">Nuovo Codice IVA</h1>
            ...
            <form @submit.prevent="submit" class="bg-white rounded-lg shadow p-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <PrimaryButton :disabled="form.processing">
                        {{ form.processing ? 'Salvataggio...' : 'Salva Codice IVA' }}
                    </PrimaryButton>
                </div>
            </form>
        </div>
