...
import { FunnelIcon, ExclamationTriangleIcon, ChevronLeftIcon, ChevronRightIcon } from '@heroicons/vue/24/outline';
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
                ...
                <div v-if="totaleScaduto > 0" class="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-700 rounded-lg p-4 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-orange-700 dark:text-orange-300">Totale crediti scaduti: <strong>{{ formatEur(totaleScaduto) }}</strong></p>
                    </div>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <tr v-for="f in fatture.data" :key="f.id"
                                :class="['hover:bg-gray-50 dark:hover:bg-gray-750', isScaduta(f) ? 'bg-orange-50 dark:bg-orange-900/10' : '']">
                                <td class="px-4 py-3 whitespace-nowrap font-medium" :class="isScaduta(f) ? 'text-orange-700 dark:text-orange-400' : 'text-gray-900 dark:text-gray-100'">
